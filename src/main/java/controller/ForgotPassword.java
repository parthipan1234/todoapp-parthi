			...
			if(u!=null) {
		        ...
		        Session session = Session.getInstance(props, new Authenticator() {
		            ...
		            protected PasswordAuthentication getPasswordAuthentication() {
		                ...
		                return new PasswordAuthentication("parthisen7339@gmail.com", "parthi@123");
		            }
		        });
		        ...
		        message.setFrom(new InternetAddress("parthisen7339@gmail.com")); // Replace with your email
